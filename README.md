...
- Here I will explain the process of making a bootable USB drive. So be patience:
  ...
  - Open "Disk Utility" and format your USB pendrive according to this configuration: [Photo](https://github.com/md-siam/Hackintosh-Legion-Y730_Y740/blob/master/images/USB_Formatting.png)
